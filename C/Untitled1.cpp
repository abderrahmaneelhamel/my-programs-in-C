	...
	if(choix == 4){
		...
		if(choix ==5 ){
				...
				for(i=n+5; i<n+10+n; i++){
					...
					printf("\nla moyenne des prix des produits vendus en journée  : %d",m);
					printf("\nla max des prix des produits vendus en journée  : %d",max);
					printf("\nla min des prix des produits vendus en journée  : %d",min);
